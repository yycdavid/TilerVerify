...
def main():
    ...
    parser.add_argument('--offset_min_size', type=float, default=0.05, help='path to file to further divide boxes')
    parser.add_argument('--angle_min_size', type=float, default=0.05, help='path to file to further divide boxes')
    args = parser.parse_args()

    generate_data.gen_bbox_from_file(args.read_from_folder, args.write_to_folder, args.num_threads, args.noise, args.noise_scale, args.offset_min_size, args.angle_min_size)
